...
import { deleteFirebaseFile, uploadImageToFirebase } from "../../utils/firebaseHandler";
import { upload } from "../../middleware/uploadMiddleware";

const router = Router();

router.put("/:id", checkAuthWithCookie, upload.single("image"), async (req: AuthRequest<TeacherRequestBody>, res: Response) => {
